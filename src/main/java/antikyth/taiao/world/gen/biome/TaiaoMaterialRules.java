...
public class TaiaoMaterialRules {
	...
	/**
	 * The swampy water of the {@link TaiaoBiomes#KAHIKATEA_SWAMP}.
	 */
	public static final MaterialRule KAHIKATEA_SWAMP = biomeSurface(TaiaoBiomes.KAHIKATEA_SWAMP, SWAMP_SURFACE);

	public static final MaterialRule ALL = MaterialRules.sequence(NATIVE_FOREST, KAHIKATEA_SWAMP);
