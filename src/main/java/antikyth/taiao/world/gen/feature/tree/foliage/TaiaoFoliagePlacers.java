...
package antikyth.taiao.world.gen.feature.tree.foliage;
...
public class TaiaoFoliagePlacers {
    public static final FoliagePlacerType<SingleFoliagePlacer> SINGLE_FOLIAGE_PLACER = register(
            Taiao.id("single_foliage_placer"),
            SingleFoliagePlacer.CODEC
    );

    public static <P extends FoliagePlacer> FoliagePlacerType<P> register(Identifier id, Codec<P> codec) {
