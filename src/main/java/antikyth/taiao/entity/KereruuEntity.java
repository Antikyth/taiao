...
public class KereruuEntity extends AnimalEntity {
	protected KereruuEntity(
	...
	protected void initGoals() {
		...
		this.goalSelector.add(
			3,
			new TemptGoal(this, 1.0, Ingredient.fromTag(TaiaoItemTags.KERERUU_FOOD), false)
		);
	...
	public @Nullable PassiveEntity createChild(ServerWorld world, PassiveEntity otherParent) {
		return TaiaoEntities.KERERUU.create(world);
	}

	@Override
	public boolean isBreedingItem(@NotNull ItemStack stack) {
		return stack.isIn(TaiaoItemTags.KERERUU_FOOD);
	}
}
